...
mongoose
  .connect(
    "mongodb+srv://ajay:1234%40@recipie01.hgvhg.mongodb.net/recipie?retryWrites=true&w=majority&appName=recipie01",
    {
...
const transporter = nodemailer.createTransport({
  service: "gmail",
  auth: {
    user: "karnat.22mech@kongu.edu",
    pass: " ucga syif yrcu ighv",
  },
...
app.post("/api/verify-otp", async (req, res) => {
  ...
  try {
    if (!tempEmail)
      return res
        .status(400)
        .json({ message: "No email found. Please sign up first." });
